...
- Comprendre les bases de la **programmation** (CircuitPython / MicroPython).  
...
- *(À venir)* **Kit de programmation** : inclut un livret et des exemples de programmes à modifier  
...
- Le matériel est fourni, il est basé sur une carte **ESP32**  
- Pour visualiser les démos : un téléphone, ordinateur ou tablette  
- Pour modifier les programmes : un ordinateur (PC ou tablette)  
...
Elle n’a pas la patine professionnelle que l’on pourrait attendre d’un produit commercial.  
...
Dans ce cas, n’hésitez pas à nous écrire pour toute **suggestion** ou **réclamation** :  
